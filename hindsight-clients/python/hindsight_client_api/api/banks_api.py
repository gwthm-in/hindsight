...
class BanksApi:
    ...
    async def test_bank_llm(
        ...
        _param = self._test_bank_llm_serialize(
            bank_id=bank_id,
            authorization=authorization,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    async def test_bank_llm_with_http_info(
        self,
        bank_id: StrictStr,
        authorization: Optional[StrictStr] = None,
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[BankLlmHealthResponse]:
        """Test the bank's LLM connectivity
    ...
    @validate_call
    async def test_bank_llm_without_preload_content(
        self,
        bank_id: StrictStr,
        authorization: Optional[StrictStr] = None,
        _request_timeout: Union[
    ...
    def _test_bank_llm_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v1/default/banks/{bank_id}/health/llm',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
